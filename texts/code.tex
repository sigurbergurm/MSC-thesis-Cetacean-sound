...
\lstinputlisting[language=C++, firstline=69,
lastline=83, caption={ContinousAnalogRead.cpp},
label={src:ContAnalogRead}]{src/ContAnalogRead.cpp}


\lstinputlisting[language=C++, firstline=1,
lastline=87, caption={PDBContinousAnalogread main program},
label={src:PDBContinuousAnalogRead}]{src/PDBContinuousAnalogRead.cpp}

\lstinputlisting[language=C++ ,firstline=1,
lastline=79, caption={PDB initilization},
label={src:PDBINO}]{src/PDB.cpp}

\lstinputlisting[language=C++, firstline=1,
lastline=126, caption={DMA initilization},
label={src:DMAINO}]{src/DMA.cpp}

\lstinputlisting[language=C++, firstline=1,
lastline=222, caption={ADC initilization},
label={src:ADC}]{src/ADC.cpp}
