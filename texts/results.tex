...
\fxfatal{þarf sennilega að vera flattop ?? }
...
%https://dspace.mit.edu/bitstream/handle/1721.1/74140/2-017j-spring-2006/contents/lecture-notes/05_3uap_notes.pdf
\textbf{$Vpeak to peak = 2\sqrt{2}*Vrms$}



\fxfatal{TALA UM NIÐURSTöður}
